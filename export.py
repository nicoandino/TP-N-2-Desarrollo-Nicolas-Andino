...
class XMLImportTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.environ['DEV_DATABASE_URI'] = 'postgresql+psycopg2://matuu:matu@localhost:5432/dev_sysacad'
    ...
    def test_import_xml_to_db(self):
        ...
        for item in root.findall('_expxml'):
            ...
            if facultad_element is not None and nombre_element is not None:
                ...
                print(f"skipeo el item por que falta 'facultad' o 'nombre': {ET.tostring(item, encoding='unicode')}")
